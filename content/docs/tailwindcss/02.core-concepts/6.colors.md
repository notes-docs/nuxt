...
整个调色板可用于所有与颜色相关的实用程序，包括 背景颜色([background color](https://tailwindcss.com/docs/background-color))、边框颜色([border color](https://tailwindcss.com/docs/border-color))、填充([fill](https://tailwindcss.com/docs/fill))、文本插入符颜色([caret color](https://tailwindcss.com/docs/caret-color))等等。

## 使用颜色
### 使用颜色实用程序

使用 `bg-white`、`border-pink-300` 和 `text-gray-950` 等颜色实用程序来设置设计中元素的不同颜色属性：
...
| 实用程序   | 描述                     |
| -------- | ------------------------ |
| `bg-*`   | 设置元素的 [背景颜色](https://tailwindcss.com/docs/background-color) |
| `text-*` | 设置元素的 [文本颜色](https://tailwindcss.com/docs/text-color) |
| `decoration-*` | 设置元素的 [文本装饰颜色](https://tailwindcss.com/docs/text-decoration-color) |
| `border-*` | 设置元素的 [边框颜色](https://tailwindcss.com/docs/border-color) |
| `outline-*` | 设置元素的 [轮廓颜色](https://tailwindcss.com/docs/outline-color) |
| `shadow-*` | 设置 [阴影](https://tailwindcss.com/docs/box-shadow#setting-the-shadow-color) 的颜色           |
| `inset-shadow-*` | 设置 [内阴影](https://tailwindcss.com/docs/box-shadow#setting-the-inset-shadow-color) 的颜色         |
| `ring-*`   | 设置 [外轮廓](https://tailwindcss.com/docs/box-shadow#setting-the-ring-color) 的颜色         |
| `inset-ring-*` | 设置 [内轮廓](https://tailwindcss.com/docs/box-shadow#setting-the-inset-ring-color) 的颜色         |
| `accent-*` | 设置表单控件的 [强调色](https://tailwindcss.com/docs/accent-color) |
| `caret-*`  | 设置表单控件的 [光标颜色](https://tailwindcss.com/docs/caret-color) |
| `fill-*`   | 设置 SVG 元素的 [填充颜色](https://tailwindcss.com/docs/fill) |
| `stroke-*` | 设置 SVG 元素的 [描边颜色](https://tailwindcss.com/docs/stroke) |
...
>
  <div class="mx-auto inline-grid max-w-lg grid-cols-1 justify-center gap-3 sm:grid-cols-10 sm:flex-row">
    <div class="flex items-center gap-1.5 sm:flex-col">
...
使用 `dark` 变体编写类似 `dark:bg-gray-800` 的类，该类仅在激活夜间模式时应用颜色：
...
在 [夜间模式文档](https://tailwindcss.com/docs/dark-mode) 中了解更多关于夜间模式样式的知识。
...
您也可以在实用程序类中将它们用作 [任意值](https://www.google.com/search?q=https://tailwindcss.com/docs/adding-custom-styles%23using-arbitrary-values)：
...
要在 CSS 中将颜色作为变量引用时快速调整其不透明度，Tailwind 包含一个特殊的 `--alpha()` 函数：
...
现在，除了默认颜色之外，您的项目中还将可以使用 `bg-midnight`、`text-tahiti` 和 `fill-bermuda` 等实用程序。

在 [主题变量文档](https://www.google.com/search?q=https://tailwindcss.com/docs/theme%23theme-variables) 中了解更多关于主题变量的知识。
...
在 [主题文档](https://www.google.com/search?q=https://tailwindcss.com/docs/theme%23referencing-other-values) 中了解更多关于引用其他变量的信息。
